...
def mask_test_edges(adj, test_frac=0.2, val_frac=0.1, prevent_disconnect=True, verbose=False):
    ...
    if (len(val_edges) < num_val or len(test_edges) < num_test):
        ...
        print
        "Num. (test, val) edges returned: (", len(test_edges), ", ", len(val_edges), ")"
    ...
    return adj_train, train_edges.tolist(), train_edges_false.tolist(), \
           val_edges.tolist(), val_edges_false.tolist(), test_edges.tolist(), test_edges_false.tolist()
